...
class CHGNet(nn.Module):
    ...
    def from_file(cls, path: str, **kwargs) -> CHGNet:
        ...
        state = torch.load(path, map_location=torch.device("cpu"), weights_only=False) #YL20240925 for loading own trained model
    ...
    def load(
        ...
        *,
        ...
        checkpoint_path = {
            ...
            "active_learning"   : "../pretrained/active_learning/epoch60_e43_f68_s256_m94.pth.tar"
        }.get(model_name)
